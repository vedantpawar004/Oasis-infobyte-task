...
public class OnlineReservationSystem {
    ...
    public static void CancellationSystem(String name, int age, String start, String end, int PNR, int Class_Type,
            String date, String train_name, int Train_Number) {
    ...
    public static void ReservationSystem() {
        ...
        System.out.print("Enter Class Type (in Number Format): ");
        try {
    ...
    public static void ticket(String name, int age, String start, String end, int PNR, int Class_Type, String date,
            String train_name, int Train_Number) {
    ...
    public void Cancelticket(String name, int age, String start, String end, int PNR, int Class_Type, String date,
            String train_name, int Train_Number) {
